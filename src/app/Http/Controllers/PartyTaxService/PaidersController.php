...
class PaidersController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('partytax.rooms.paiders', ['expenseNumber' => $this->paidersForExpensesNumber, 'roomMembers' => $currentRoomMembers, 'pageName' => 'Кто скидывается', 'currentExpensePaiders' => $currentExpensePaiders]);
    }
