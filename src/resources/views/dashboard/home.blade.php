...
@section('specific_content')
    <div class="partytax page">
        <div class="container">
            <h2 class="partytax__title">
                PartyTax Home
            </h2>
            <div class="partytax__home-box">
                <a href="{{ route('profile.edit') }}" class="partytax__home-item alert alert-primary">
                    <div class="partytax__home-item-title">
                        Профиль
                    </div>
                    <div class="partytax__home-item-icon">
                ...
                <a href="#" class="partytax__home-item alert alert-success">
                    <div class="partytax__home-item-title">
                        Как <br>пользоваться
                    </div>
                    <div class="partytax__home-item-icon">
