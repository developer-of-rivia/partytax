...
@section('specific_content')
    <div class="partytax page">
        <div class="container">
            <form action="{{ route('partytax-room-mebmers-add') }}" method="POST" class="add-members-form">
                @csrf
            ...
            <a href="{{ route('partytax-room-members-favs') }}" class="btn btn-secondary">Избранные</a>
        </div>
    </div>
@endsection